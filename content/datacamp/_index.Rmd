...
Interactive training sections are provided as a courtesy by [Data Camp](https://www.datacamp.com/){target="_blank"}^[Please note that if you have (1) used Data Camp before and (2) are logged in with the same username, then any module that was successfully completed will not have to be done again.]. 
