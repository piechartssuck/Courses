...
If you want to give the entire data set a go, I am not certain how to load it in Excel, but in RStudio you can use
...
## Looking Ahead
Next week we get into uncovering underlying traits and groupings that a data set may have using a process called Exploratory Factor Analysis. While there certainly a level of complexity that has to be understood, the return in information you can get about a measurable data set far outweighs the cost.  
