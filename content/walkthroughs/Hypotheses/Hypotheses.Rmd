...
Download a [script](/walkthroughs/Hypotheses.R){target="_blank"} file of just the R chunks used in this walkthrough.
...
* **Assumption #1: Random sampling**: Data is derived from random sampling.
