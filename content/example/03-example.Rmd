---
title: "Reliable? Oh thats Sweet but I Really Meant Your Data."
...
kable(big_five_data_EXT 
  ...
  kable_styling(full_width = FALSE, 
                ...
                column_spec(2, color='white', background='#52bf90', include_thead = TRUE)  %>%        
                column_spec(4, color='white', background='#49ab81', include_thead = TRUE)  %>%
                column_spec(6, color='white', background='#419873', include_thead = TRUE)  %>%        
                column_spec(8, color='white', background='#398564', include_thead = TRUE) %>%         
                column_spec(10, color='white', background='#317256', include_thead = TRUE) %>%                        add_header_above(c("Original Data Set" = 10))
```
...
kable(big_five_data_EXT_rev 
  ...
  kable_styling(full_width = FALSE, 
                ...
                column_spec(6, color='white', background='#419873', include_thead = TRUE)  %>%        
                column_spec(8, color='white', background='#398564', include_thead = TRUE) %>%         
                column_spec(10, color='white', background='#317256', include_thead = TRUE) %>%
...
For a little preview of next weeks content, let's start with a reflection. Consider if you have administered a survey at some point in your life and had an uneasy or underlying feeling that everything is working against you. Did people tell you that you're being paranoid or its out of your control? Well you aren't just having the jitters and you actually control the survey's destiny as it were.  Is it magic? Nope because that's not a real thing, but it is a result of a fundamental law in nature called **entropy** which is **a measure of randomness or disorder in a system** and the **Second Law of Thermodynamics** (wait WHAT???) which states that entropy is forever increasing. To describe this notion, we'll be looking at two larger concepts: *threats to validity* and a bit of *probability*. 
