...
```{r img_loc, echo=FALSE}
figs <- here::here("static", "img", "examples")
```
# Getting Prepped
...
Not we'll display the results in two ways
...
Take a look at some more examples over at the **patchwork** [vignette](# https://patchwork.data-imaginist.com/articles/guides/assembly.html){target="_blank"}.
...
2. Changing the type of scaling
```{r}
p2 <- ggplot(mtcars, aes(factor(cyl), mpg, fill = factor(am))) +
  geom_bar(stat = "identity", position = "dodge") +
