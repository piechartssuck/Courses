...
### So Who is Right?
We honestly just don't know right now. Similar to physics where there are two incompatible laws governing the universe - relativity for large and quantum for small objects, respectively - statistics has the same difficulty regarding inferences. The frequentist thinking is the dominant approach because they involve "simple" calculations and appear to explain the phenomena around us really well. We've been able to explain a lot of the world with this approach where there is a single defined outcome. However with the rise of machine learning and advancements in computing in general, complex calculations now allow us to consider the possibilities of multiple outcomes which appears to be opening doors into uncharted possibilities^[No pun intended.]. In these cases, a Bayesian approach appears to be our best bet.
