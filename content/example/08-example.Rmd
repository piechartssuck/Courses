...
[Week 8 materials](/example/08-example_files/Week8materials.zip)
...
read in the text and clean it up by removing any dollar signs since they mean something different in R
```{r echo=TRUE,eval=FALSE}
...
Please do not install the `harrypotter` package via CRAN. Instead use the following. This only has to be run once.
