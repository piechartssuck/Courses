...
From time to time, I may also contains video of live coding some examples pieces so you can see what it looks like to work with R in real time. You'll definitely notice that I make all sorts of errors, which *is absolutely normal* and it happens to everyone!
