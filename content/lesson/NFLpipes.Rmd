---
title: "Dplyr, Pipes, and the NFL"
linktitle: "Week 5: Dplyr, Pipes, and the NFL"
output:
  blogdown::html_page:
    toc: true
menu:
...
Download a [script](/scripts/NFLpipes.R){target="_blank"} file of just the R chunks used in this walkthrough.
