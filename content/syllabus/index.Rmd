...
Evaluation is a practice based field so much of what you will come across will align with that notion. With that said, while I have tried to get rid of any and all theory, some basic concepts need an underlying construct or idea.
...
## Course materials
There are two texts, though you will receive some supplementary materials in the course as well.

### Texts

#### Required

We'll rely on the texts below. Both are available through the WVU library [WVU library](https://library.wvu.edu/){target="_blank"}:

- Davidson, E. J. (2007). *Evaluation methodology basics: The nuts and bolts of sound evaluation* (1st ed.). SAGE.
    - [Digital edition](https://libwvu.on.worldcat.org/oclc/646022580){target="_blank"} (free!)
...
- American Psychological Association. (2020). *Publication manual of the American Psychological Association* (7th ed.). (ISBN:  978-1433832161)
    - Spiral bound edition (not free though the WVU library have copies of the official [paperback variant](https://libwvu.on.worldcat.org/oclc/1111952681){target="_blank"} - ISBN: 978143383217
...
You will need access to your WVU [Qualtrics](https://wvu.qualtrics.com/){target="_blank"} account. Please go to the site and check if you can login. If you are enrolled as a WVU student, then you should have access. However if you do not, submit a [ticket to IT](https://wvu.teamdynamix.com/TDClient/1976/Portal/Requests/ServiceDet?ID=9102){target="_blank"} or give them a ring at [304-293-4444](callto: 304-293-4444).
...
While required for most of the methods courses I teach, you have the option in this course to learn about the open source (and free!)statistical platform [R](https://cran.r-project.org/){target="_blank"} via the software [RStudio](https://www.rstudio.com/){target="_blank"}. **You can think of R as an engine and RStudio as a car dashboard** — R handles all the calculations produces the actual statistics and graphical output, while RStudio provides a nice interface for running R code. Please note that

<div class="text-center">
**you do not need to have any programming experience to use R**
</div>

R is free, but it can sometimes be a task to install and configure. To make life easier, you can opt to use the free [RStudio.cloud](http://rstudio.cloud/){target="_blank"} service, which lets you run a full instance of RStudio in your web browser. This is recommended for those of you who do not want to install programs right now or just wabt to test it out.
...
- First you will have access to [Data Camp](https://www.datacamp.com/){target="_blank"} which allows you to relieve professional training that otherwise costs a lot of money. Is it perfect and flashy? Nope but it is interactive and if you pay attention, then R's initial steep learning curve won't feel much like an uphill battle.
...
- Fifth we have a class chatroom at [Slack](2021edp617.slack.com){target="_blank"} where you can poise a question. **I will monitor Slack regularly and will respond quickly.** (This is a rare instances where I keep notifications on so please utilize it!) Ask questions about the readings, exercises, and mini projects. You'll likely have similar questions as your peers, and you'll likely be able to answer other peoples' questions too.
...
## Due Dates & Weekly Material
All materials are due on a weekly basis by *Sunday at 11:59 PM* unless otherwise noted. New material will be posted on the course website by *Tuesday afternoon by 12:00 PM*. 
