...
You can find up to date descriptions for all the tasks on the [tasks page](/tasks/).
...
assignments <- tribble(
  ...
  15, "Check-ins", "Zoom",
  30, "Abstract and Instrument", "eCampus/Slack", 
...
*Note: The Abstract and Instrument are scored from a combination of six weekly [tasks](https://edp611.asocialdatascientist.com/tasks/). The Elevator Pitch, Abstract and Instrument together is considered to be your final task titled* ***Revise & Resubmit***.
<br />
