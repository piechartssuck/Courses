...
assignments <- tribble(
  ...
  15, "Check-ins", "Zoom",
  30, "Final Proposal Bits^[For more information, please check the [Tasks](/tasks/#final-proposal-bits) page]", "eCampus/Slack", 
  10, "Presentation Bits", "eCampus/Slack"
) 
