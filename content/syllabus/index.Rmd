...
1. Administering surveys via the Internet.
2. Constructing online surveys^[Sure paper surveys are important but they are rarely used barring small samples.].
3. Creating aesthetically pleasing surveys using color theory and design techniques^[Pretty is good!].
4. Determining how to assess survey reliability and validity of items and instruments.
5. Enhancing the look and feel of surveys using programming techniques^[Before you run really far away, the expectation here is to apply chunks of code in places rather than learning how to code.]. 
6. Evaluating what analysis technique to utilize for a given item, performing said analysis, and determining how best to report findings.
7. Using R and RStudio to pull, analyze, and construct reports on survey data. 
...
All survey design, construction and deployment will occur in [Qualtrics](https://wvu.qualtrics.com/){target="_blank"}. Please go to the site and check if you can login. If you are enrolled as a WVU student, then you should have access. However if you do not, submit a [ticket to IT](https://wvu.teamdynamix.com/TDClient/1976/Portal/Requests/ServiceDet?ID=9102){target="_blank"} or give them a ring at [304-293-4444](callto: 304-293-4444).
...
- Fifth we have a class chatroom at [Slack](2020edp619.slack.com){target="_blank"} where you can poise a question. **I will monitor Slack regularly and will respond quickly.** (This is a rare instances where I  keep notifications on so please utilize it!) Ask questions about the readings, exercises, and mini projects. You'll likely have similar questions as your peers, and you'll likely be able to answer other peoples' questions too.

- Sixth and lastly you can send items by Slack or email me with questions about content, R or whatever (after giving a graduate student effort of course). Please include the subject header **EDP 619 "the title of your email"** where the title of your email is given without the quotes. Know that I will not just give you the answer, but am happy to push you in the right direction. If you do email me, please include the following:
...
assignments <- tribble(
  ~Points,  ~Assignment,
  10 * 10, "Daily(ish) Tasks",
  13 * 10, "Data Camp",
  2 * 30, "Data Tasks",
  10, "Selecting a Population",
  25, "Survey Draft",
  25, "Pilot Study Review",
  25, "Final Survey",
  100, "Report",
  25, "Presentation" 
) %>%
...
- **Work in general**: I can't believe that this needs to be stated but previous experiences have led to this list<br>
  1. The default assumption for any graduate level class is that any submission or deliverable should be formal and that the corresponding language, grammar, syntax, etc. reflects that sentiment. In any EDP course, this also includes always using proper APA 7th edition formatting. 
  2. If you cannot take criticism, this is not the course for you. My job is to make you a better academic and practitioner. That won't happen if you are easily offended.
  3. There is a great deal of content in this course and you are likely unfamiliar with some, if not all of it. You will no doubt get frustrated at times and will sometimes have to struggle. In those times, be respectful ask for help from me or peers. I will always make time for you and historically other students have been quite helpful.
