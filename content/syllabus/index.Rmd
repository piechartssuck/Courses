...
**You can measure anything (well mostly)** Without a basic understanding of measures, you may not be sitting here today! Measurement is a principle trait and whether it is hard wired, learned, or some combination of both, its absence makes quantitative data impossible to classify. But even in cases where measures are available, how can we know if they are consistent and accurate? Without these checks, instruments such as surveys could never be constructed, much less yield results that could be generalized. 
...
- be confident in determining valid and reliable measures
- have the ability to interpret and report psychometric properties of tests
- view measurement as a typical step in the evaluative process
...
Additionally, this class will expose you to [R](https://cran.r-project.org/)—one of the most popular and in-demand statistical languages. Armed with the foundation of R skills you'll learn in this class, you'll know enough to be able to find how to analyze and visualize many outputs based on measures.
...
To help minimize costs, we do not have a formal text. However we will rely on the following for readings and reference. All are available through the WVU library [WVU library](https://library.wvu.edu/){target="_blank"} in an online capacity barring the APA 7th edition handbook.

- Balkin, R. S., &amp; Kleist, D. M. (2016). *Counseling Research: a Practitioner-Scholar Approach*. American Counseling Association. 

- Albano, T. (2020). Introduction to Educational and Psychological Measurement Using R. [https://thetaminusb.com/intro-measurement-r/ ](https://thetaminusb.com/intro-measurement-r/). 
...
- Fifth we have a class chatroom which may be accessed via [Slack](2021edp611.slack.com) where you can poise a question. **I will monitor Slack regularly and will respond relatively quickly.** Ask questions about the readings, exercises, and other course materials. You'll likely have similar questions as your peers and may be able to answer other peoples' questions too.

- Sixth and lastly you can send items by Slack or email me with questions about content, R or whatever (after giving a graduate student effort of course). Please include the subject header **EDP 611 "the title of your email"** where the title of your email is given without the quotes. Know that I will not just give you the answer, but am happy to push you in the right direction. If you do email me, please include the following:
...
You can find up to date descriptions for all the assignments on the [assignments page](/assignment/).

```{r assignments-grades, include=FALSE}
assignments <- tribble(
  ~Percent,  ~Task, ~Location,
  15, "R Training", "Data Camp",
  15, "Reflections", "Slack Channel",
  15, "R Measurement Task", "eCampus/Slack",
  15, "Synchronous Meetings", "Zoom",
  30, "Final Proposal", "eCampus/Slack", 
  10, "Presentation of Proposal", "eCampus/Slack"
) 
