...
Let's first get some tract data, in particular the median household income from the 2015-2019 ACS in Monongalia County, WV.
...
You can use the `datatable()` command from the `DT` package to see an better view of the output. Yours will look similar top what is shown below but with more functionality.
