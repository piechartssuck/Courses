...
Now we can create a custom continuous color palette. In this case we'll use the [`wesanderson`](https://github.com/karthik/wesanderson){target="_blank"} palette but please feel free to use your own.
