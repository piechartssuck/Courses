...
#### Solutions
*Note: The* $\chi^2$ *value obtained will be referenced by the variable* $\chi^2_{obt}$.
...
- Other offenders, we would make <span class="boxed">42 errors</span> given $E_2 = 9084$. 
