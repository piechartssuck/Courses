...
Please submit a PDF out using an Rmarkdown file for this task^[If you use an external file for your data, please submit that as well.]. You can use a chapter book of your choice or give the process below a go.
...
1. a chapterwise sentient analysis of your text using AFINN, Bing, and NRC with a visual of each.
2. BONUS^[Will replace the 2016 general election map activity]: a topic model of the work with a visual of the top 10 topics by prevalence.
