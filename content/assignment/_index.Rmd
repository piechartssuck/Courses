...
These postings will be graded using a check system:
  ...
  - ✔+: (*11.5 points (115%) in the gradebook*) Postings address a topic area completely and arguments are exceptional with plenty of justifications. These are not earned often.
- ✔: (*10 points (100%) in the gradebook*) Postings mostly address a topic area completely and/or arguments are on point. This is the expected level of performance.
- ✔−: (*5 points (50%) in the gradebook*) Postings generally fail to address a topic area completely and/or arguments are on off-point This is the expected level of performance. This indicates that you need to improve next time. Hopefully people will not earn this often.

Otherwise *0 points (0%) in the gradebook*.
