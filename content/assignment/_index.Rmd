...
To encourage engagement with the course content, you'll need to write a ~150 word reflection about the readings for the day. That's fairly short: there are ~250 words on a typical double-spaced page in Microsoft Word (500 when single-spaced). 
...
You will turn these reflections on the Discussion Board on [eCampus](https://ecampus.wvu.edu/webapps/login/).
...
Complete details for the final project will be posted here at the halfway point through the course. To preview, you will

1. Develop a test with items.
2. Conduct assessments addressing the test's validity and reliability including performing a factor analysis.

**This project serves as your final exam.**

The project will ***not*** be graded using a check system. If you've engaged with the course content and completed the exercises and mini projects throughout the course, you should do just fine with the final project.
