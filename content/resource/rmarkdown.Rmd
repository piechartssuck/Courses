...
You may have guessed that [R Markdown](https://rmarkdown.rstudio.com/){target="_blank"} is [regular Markdown](/reference/markdown/) with R code and output sprinkled in. Simply put, its

<center>
**R + Markdown = R Markdown** 
</center>
<br>
You can do everything you can with [regular Markdown](/reference/markdown/), but you can also incorporate graphs, tables, and other R output directly in your document. You can create HTML, PDF, and Word documents, PowerPoint and HTML presentations, websites, books, and even [interactive dashboards](https://rmarkdown.rstudio.com/flexdashboard/index.html){target="_blank"} with R Markdown. The website for this course was created with R Markdown (and [a package named **blogdown**](https://bookdown.org/yihui/blogdown/){target="_blank"}) and is updated using the same platform.

## Learning R Markdown

- [Data Camp](https://learn.datacamp.com/courses/reporting-with-r-markdown){target="_blank"} has a good module on learning how to create R Markdown documents.
- [Getting started in R and RStudio](http://milton-the-cat.rocks/learnr/r/r_getting_started/){target="_blank"} is created by Andy Fields and is a great step-by-step introduction to both R and R Markdown and you can skip around using a Table of Contents.
- [R Markdown Basics](https://stats.idre.ucla.edu/stat/data/rmarkdown/rmarkdown_seminar_flat.html){target="_blank"} is a very comprehensive primer solely focused on R Markdown. Andy Lin, the author of the walkthrough assumes that you have some working knowledge of R, namely RStudio. 

## Source Materials

The [documentation for R Markdown](https://rmarkdown.rstudio.com/){target="_blank"} is extremely comprehensive, and their [tutorials](https://rmarkdown.rstudio.com/lesson-1.html){target="_blank"} and [cheatsheets](https://rmarkdown.rstudio.com/lesson-15.html){target="_blank"} are excellent. Use them as resources.
